...
private:
    ...
    Game* game; 
    // Create a vector of vectors which stores integers. Grid stores the
    // pre-filled grid generated by the game and userGrid stores the user inputs
    vector<vector<int>> grid, userGrid;
    

public:
    Grid(); // Default constructor for the Grid class
    // Set the value of the cell [row][col] to the value
    void SetValue(int row, int col, int value);
    // Get the current value of the cell [row][col]
